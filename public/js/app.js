...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_sweetalert__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_multilanguage__ = __webpack_require__(15);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('section-home', __webpack_require__(40));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('section-faqs', __webpack_require__(46));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('section-token', __webpack_require__(51));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('section-contact', __webpack_require__(56));
...
var update = __webpack_require__(2)("345ef096", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_sweetalert__ = __webpack_require__(6);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitEmail: function submitEmail(event) {
            ...
            var self = this;
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/newsletterUser', {
    ...
    mounted: function mounted() {
        var self = this;
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/getTokens').then(function (response) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("f3c80814", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4c3d11a0", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-xs-12 col-md-12" }, [
        _c("h1", [
          _vm._v("SEND ETH TO THIS ADRESS AND RECEIVE POW TOKENS "),
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "panel-body" }, [
                    ...
                    _c("p", [
                      _vm._v(
                        "2. Do not lose this password. Losing this password is equivalent to losing all ETH and POW stored in your account. Click on the "
                      ),
                    ...
                    _c("p", { staticClass: "instructions-note" }, [
                      ...
                      _vm._v(
                        " you won’t be able to access your account without this file and the password from the previous step. Losing either one of them is equivalent to losing all ETH and POW stored in your account."
                      )
                    ]),
                    _vm._v(" "),
                    _c("h4", [
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4052f892", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multilanguage__ = __webpack_require__(15);
